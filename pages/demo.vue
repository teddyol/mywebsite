  ...
  <div class="container">
    ...
    <master-com>
      <div slot="content"
        ...
        <nuxt-link to="/about"
                   target="_blank">跳转</nuxt-link>
        <nuxt-link :to="{name: 'about', params: {newsId: 3306}, query: {queryId: 3307}}">带参跳转</nuxt-link>
        <nuxt-link to="/about?id3=55">拼接跳转</nuxt-link>
        <span @click="toSkipFn">事件跳转</span>
        <br>

        <button class="button is-link"
                @click="getProvinceFn">获取数据</button>
        <div class="tags">
